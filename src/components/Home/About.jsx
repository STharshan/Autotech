...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Great experience all round, severe manifold leak on an extremely awkward and time consuming engine (and missing parts from a previous workshop!). Kept me updated all the way through, now drives like a new van. Very fair price as well, highly recommended.",
    name: "Most relevant",
  },
