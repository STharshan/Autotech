...
const services = [
  {
    title: "Diagnostics",
    desc: `Vehicle diagnostics use advanced tools to detect issues with the engine, transmission, or other key systems, helping to pinpoint problems and optimize repairs.`,
    image: "/carpaint.avif",
    path: "/services/mechanical",
  },
  {
    title: "Engine Remapping",
    desc: `Engine remapping involves reprogramming a vehicle’s ECU to improve performance, fuel efficiency, or adjust engine parameters for specific needs.
​`,
    image: "/gray.avif",
  ...
  },
  {
    ...
    desc: `Cambelt replacement involves changing the timing belt that controls the engine’s camshaft, preventing engine damage due to belt wear or failure.`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[85%] mt-25 mx-auto h-30 rounded-2xl object-cover"
                    onError={(e) => {
